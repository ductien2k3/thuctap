    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h1 class="text-center">Cập nhật đơn hàng đơn hàng #{{ $order->id }}</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                ...
                <form action="{{ route('customer.update', $order->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control mt-2" id="status" name="status">
                            <option value="Đang chờ xác nhận đơn hàng" {{ $order->status === 'Đang chờ xác nhận đơn hàng' ? 'selected' : '' }}>Đang chờ xác nhận đơn hàng</option>
                            <option value="Đã xác nhận đơn hàng , chuẩn bị gửi hàng" {{ $order->status === 'Đã xác nhận đơn hàng , chuẩn bị gửi hàng' ? 'selected' : '' }}>Đã xác nhận đơn hàng, chuẩn bị gửi hàng</option>
